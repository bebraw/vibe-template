  ...
  rules: [
    {
      ...
      expression: "true",
      action_parameters: {
        ratelimit: { characteristics: ["cf.colo.id", "ip.src"], period: 60, requests_per_period: 100, mitigation_timeout: 600 },
      },
    },
    {
      action: "block",
      expression: 'http.request.uri.path eq "/api/login"',
      action_parameters: { ratelimit: { characteristics: ["ip.src"], period: 60, requests_per_period: 5, mitigation_timeout: 600 } },
    },
  ],
});
```
