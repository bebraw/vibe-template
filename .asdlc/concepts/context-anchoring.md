...
description: >-
  The phenomenon where explicit context biases an LLM toward specific concepts
  or solutions, even when marked as deprecated or irrelevant to the immediate
  task.
tags:
  - Psychology
  - LLM
...
references:
  - type: paper
    ...
    annotation: >-
      Empirical study showing that LLM-generated context files reduce task
      success by 2-3% while increasing cost by over 20% due to redundant
      information.
  - type: paper
    ...
    annotation: >-
      Research demonstrating that LLMs struggle to retrieve and use information
      placed in the middle of long contexts, highlighting the cost of noise.
  - type: website
    ...
    annotation: >-
      Introduces the 'Pink Elephant Problem' in the context of AGENTS.md and
      coding agents.
---
> **ASDLC Knowledge Base** | Status: Live | [View Online](https://asdlc.io/concepts/context-anchoring)
...
Applied in: 
- [Context Engineering](../concepts/context-engineering.md) (as the reason why Toolchains serve as vital Context Reduction)
- [AGENTS.md Specification](../practices/agents-md-spec.md) (enforcing the "Minimal by Design" philosophy)
- [Context Map](../patterns/context-map.md) (separating navigation from ingestion to avoid overloading the context window)
