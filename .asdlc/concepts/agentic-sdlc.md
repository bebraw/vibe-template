...
description: >-
  Complete framework for industrializing software development with AI agents.
  Defines how agents serve as the logistic layer while humans design, govern,
  and optimize the production flow.
tags:
  - Core
  - SDLC
  - Methodology
...
status: Live
---
> **ASDLC Knowledge Base** | Status: Live | [View Online](https://asdlc.io/concepts/agentic-sdlc)
...
- **Provenance is Value** — In a world of infinite code, value shifts to [Provenance](../concepts/provenance.md): the audit trail of who steered the agent and how it was verified.

## The Cybernetic Model

ASDLC operates at [L3 Conditional Autonomy](../concepts/levels-of-autonomy.md)—a "Fighter Jet" model where the Agent acts as the Pilot executing maneuvers, and the Human acts as the Instructor-in-the-Cockpit.
...
The underlying machinery that builds the agents themselves. While the [Ralph Loop](../patterns/ralph-loop.md) produces code, the [Agent Optimization Loop](../patterns/agent-optimization-loop.md) produces better agents by testing them against **Scenarios** rather than static benchmarks.

## ASDLC Usage

Full project vision: [/docs/vision.md](../../docs/vision.md)

Applied in: [Specs](../patterns/the-spec.md), [AGENTS.md Specification](../practices/agents-md-spec.md), [Context Gates](../patterns/context-gates.md), [Model Routing](../patterns/model-routing.md), [Agent Optimization Loop](../patterns/agent-optimization-loop.md)
