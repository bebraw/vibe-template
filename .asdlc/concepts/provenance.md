...
title: Provenance
description: >-
  The chain of custody and intent behind software artifacts, distinguishing
  high-value engineered systems from 'slop'.
tags:
  - Core
  - Philosophy
  - Quality
...
---
> **ASDLC Knowledge Base** | Status: Experimental | [View Online](https://asdlc.io/concepts/provenance)
...
**Applied in:**
*   [The Spec](../patterns/the-spec.md) — The primary artifact of Intent Provenance.
*   [Context Gates](../patterns/context-gates.md) — The checkpoints of Verification Provenance.
*   [Micro-Commits](../practices/micro-commits.md) — The unit of Audit Provenance.
