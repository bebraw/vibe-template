...
description: >-
  A diagnostic framework for software system health built around three
  interacting debt types that accumulate as AI accelerates development.
tags:
  - Architecture
  - SDLC
  - Code Quality
...
status: Experimental
publishedDate: 2026-03-25T00:00:00.000Z
lastUpdated: 2026-03-25T00:00:00.000Z
references:
  - type: paper
    title: >-
      From Technical Debt to Cognitive and Intent Debt: Rethinking Software
      Health in the Age of AI
    url: 'https://arxiv.org/abs/2603.22106'
    author: Margaret-Anne Storey
    published: 2026-03-23T00:00:00.000Z
    accessed: 2026-03-25T00:00:00.000Z
    annotation: >-
      Seminal paper defining the Triple Debt Model. Reviewed by Kent Beck, Adam
      Tornhill, Mary Shaw, Marian Petre, Markus Borg, Dave Thomas.
  - type: paper
    title: >-
    ...
    accessed: 2026-03-25T00:00:00.000Z
    annotation: >-
      Defines Cognitive Surrender — adopting AI outputs with minimal scrutiny,
      bypassing both intuition and deliberate reasoning. Distinct from Cognitive
      Offloading.
  - type: website
    ...
    accessed: 2026-03-25T00:00:00.000Z
    annotation: >-
      Early practitioner discussion of cognitive debt in AI-assisted
      development, cited by Storey.
---
> **ASDLC Knowledge Base** | Status: Experimental | [View Online](https://asdlc.io/concepts/triple-debt-model)
...
- **Characteristics**: Practitioner terms like "context debt" are symptoms of systemic Intent Debt. Intent is inherently ephemeral; it is best captured at the exact moment of decision (e.g., during the [Learning Loop](../concepts/learning-loop.md)). Unlike technical debt, lost intent cannot always be reverse-engineered later. Once intent is gone, any future modifications are blind guesses.
...
*   **Mitigating Intent Debt**: ASDLC mandates "intent-first" workflows. Intent Debt is primarily combatted through the [Agent Constitution](../patterns/agent-constitution.md) (project-level intent), [The Spec](../patterns/the-spec.md) (feature-level intent), [ADRs](../patterns/the-adr.md) (decision rationale), and [BDD Scenarios](../concepts/behavior-driven-development.md) (executable intent).
*   **Mitigating Cognitive Debt**: Addressed through [Human-in-the-Loop](../concepts/levels-of-autonomy.md) reviews, the [Learning Loop](../concepts/learning-loop.md), and [Adversarial Requirement Reviews](../practices/adversarial-requirement-review.md). Crucially, the *process* of authoring and refining a specification builds genuine cognitive alignment across the team.
*   **Mitigating Technical Debt**: Controlled via [Context Gates](../patterns/context-gates.md), deterministic automated verification, and AI-assisted continuous refactoring.
