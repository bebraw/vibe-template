...
description: >-
  A software development methodology emphasizing high-frequency feedback,
  testing, and continuous refactoring, which maps perfectly to the Agentic SDLC.
tags:
  - Agile
  - Methodology
  - TDD
...
references:
  - type: website
    ...
    author: Don Wells
    accessed: 2026-02-24T00:00:00.000Z
    annotation: Foundational rules and practices of Extreme Programming.
---
> **ASDLC Knowledge Base** | Status: Live | [View Online](https://asdlc.io/concepts/extreme-programming)
...
Agents do not suffer from fatigue context-switching. Therefore, the "Continuous Integration" of XP becomes a literal [Cybernetic Loop](../concepts/agentic-sdlc.md#the-cybernetic-loop), wherein agents merge, test, and validate micro-commits continuously.

### 4. Continuous Refactoring $\rightarrow$ Agent Optimization Loops
While agents refactor application code to manage technical debt, the overarching system refactors the *agents themselves*. The [Agent Optimization Loop](../patterns/agent-optimization-loop.md) continuously tests agents against Scenarios to refine their underlying prompts and instructions (e.g., distilling their `AGENTS.md` context files) based on failure rates.
...
Applied in:
- [Agentic SDLC](../concepts/agentic-sdlc.md) 
- [Context Gates](../patterns/context-gates.md) 
- [Agent Optimization Loop](../patterns/agent-optimization-loop.md)
