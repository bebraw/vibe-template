...
description: >-
  Context Engineering is the practice of structuring information to optimize LLM
...
references:
  - type: website
    ...
    annotation: >-
      Three-layer context model (Local/Repository/Organizational) with Spotify's
      Backstage-based implementation as case study. Product pitch for Roadie,
      but the layered framing and IDP-as-context-engine thesis are useful for
  ...
  - type: website
    ...
    annotation: >-
      Foundational guidance on structuring prompts and context for optimal LLM
      performance.
  - type: website
    ...
    accessed: 2026-01-08T00:00:00.000Z
    annotation: >-
      Documentation on Anthropic's approach to AI alignment and context-based
      safety constraints.
  - type: paper
    ...
    annotation: >-
      Research identifying the cold start problem as the primary blocker in
  ...
  - type: paper
    ...
    annotation: >-
      Empirical validation of file-centric state management for long-horizon
      agent stability.
  - type: website
    title: 'Agile in the AI Era: Why ''Boring'' Architecture Is Your Secret Weapon'
    url: >-
      https://www.linkedin.com/pulse/agile-ai-era-why-boring-architecture-your-secret-weapon-lefever-ravne/
    author: Raf Lefever
    published: 2026-02-10T00:00:00.000Z
    accessed: 2026-02-12T00:00:00.000Z
    annotation: >-
      Argues that domain-driven structure ('Screaming Architecture') is critical
  ...
  - type: website
    ...
    accessed: 2026-02-16T00:00:00.000Z
    author: Vercel
    annotation: >-
      Validation of passive context mapping over active tool retrieval for
      static knowledge.
  - type: paper
    title: >-
    ...
    author: >-
      Thibaud Gloaguen, Niels Mündler, Mark Müller, Veselin Raychev, Martin
      Vechev
    publisher: ETH Zurich / LogicStar.ai
    published: 2026-02-13T00:00:00.000Z
    annotation: >-
      Empirical study showing that unnecessary context file instructions
      increase agent reasoning cost and reduce task success rates. Agents follow
      instructions faithfully — making constraint minimalism a performance
      concern, not just an aesthetic one.
---
> **ASDLC Knowledge Base** | Status: Live | [View Online](https://asdlc.io/concepts/context-engineering)
...
Context Engineering extends to the filesystem itself. As [Raf Lefever](../concepts/context-engineering.md#references) notes, "If your code-base doesn't scream its domain, AI will whisper nonsense."
...
Furthermore, agents are highly susceptible to [Context Anchoring](../concepts/context-anchoring.md). Telling an LLM what *not* to do ensures that the concept is front-and-center in its attention mechanism. If your `AGENTS.md` says "do not use tRPC", the agent might still reach for it because the token `tRPC` is highly active in the context window.
...
**Applied in:**
- [AGENTS.md Specification](../practices/agents-md-spec.md) — The practical application of context engineering in repositories.
- [Model Context Protocol](../concepts/model-context-protocol.md) — The standard for serving context to agents.

**Related Patterns:**
- [Specs](../patterns/the-spec.md) — Specs are context engineering in document form.
- [Context Gates](../patterns/context-gates.md) — Checkpoints where context is validated.
- [Context Map](../patterns/context-map.md) — The structural pattern for organizing context.
- [Agent Optimization Loop](../patterns/agent-optimization-loop.md) — Verifying context quality.
- [Context Offloading](../practices/context-offloading.md) — Operational practice for preventing context rot.
