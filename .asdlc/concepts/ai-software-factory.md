...
description: >-
  An industrial-scale approach to software engineering. Explores the dichotomy
  between Safe ASDLC Factories (L3) and high-risk Dark Factories (L4).
tags:
  - Architecture
  - Industrialization
  - SDLC
...
references:
  - type: website
    ...
    annotation: >-
      Legal and regulatory analysis of the governance gaps inherent in Dark
      Factory non-interactive development models.
  - type: website
    title: >-
      How StrongDM’s AI team build serious software without even looking at the
      code
    ...
    accessed: 2026-03-09T00:00:00.000Z
    annotation: >-
      Provides a practical example of a 'Dark Factory' leveraging specs, holdout
      scenarios, and digital twins.
  - type: website
    ...
    accessed: 2026-03-09T00:00:00.000Z
    annotation: >-
      Original source material detailing non-interactive development driven by
      scenarios and agentic loops.
---
> **ASDLC Knowledge Base** | Status: Experimental | [View Online](https://asdlc.io/concepts/ai-software-factory)
...
This model operates at [Level 3 (Conditional) Autonomy](../concepts/levels-of-autonomy.md). Agents act as the high-throughput generation engine on the assembly line, but humans retain the ultimate verification controls. 

Driven by rigorous [Spec-Anchored Development](../concepts/spec-driven-development.md), human engineers define the architecture and act as the final **Acceptance Gate**. Crucially, the human elevates from *Code Auditor* to *Change Owner*. By relying on automated Quality Gates and agentic Review Gates for line-by-line syntax and specification checks, the human focuses PR reviews on the structural footprint ("what files changed?") and strategic fitness ("does this solve the problem safely?"). They approve state transitions and maintain complete [Provenance](../concepts/provenance.md) over what enters production without becoming a bottleneck.
...
To achieve this testing scale without exhausting API rate limits or incurring massive vendor costs, Dark Factories utilize [Digital Twins](../concepts/digital-twins.md)—high-fidelity, in-memory clones of required third-party services (e.g., Slack, Stripe, Jira).
