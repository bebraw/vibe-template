...
description: >-
  Using frontier models to derive specifications from existing code to bootstrap
  the Agentic SDLC in brownfield projects.
tags:
  - Brownfield
  - Specification
  - Bootstrapping
...
references: []
---
> **ASDLC Knowledge Base** | Status: Experimental | [View Online](https://asdlc.io/patterns/spec-reversing)
