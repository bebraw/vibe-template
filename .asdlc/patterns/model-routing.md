...
title: Model Routing
description: >-
  Strategic assignment of LLM models to SDLC phases based on reasoning
  capability versus execution speed.
tags:
  - LLM Selection
  - Context Engineering
  - ASDLC
...
references:
  - type: paper
    ...
    publisher: LMSYS
    annotation: >-
      Foundational research on using matrix factorization for routing,
      demonstrating Pareoto-optimal trade-offs.
  - type: paper
    title: >-
  ...
  - type: website
    ...
    annotation: >-
      Addy Osmani's workflow guide emphasizing pragmatic model selection and
      mid-task model switching patterns based on reasoning needs.
  - type: website
    ...
    annotation: >-
      Documents latency, cost, and reliability constraints from enterprise
      practice.
  - type: paper
    title: >-
      SWE-Protégé: Learning to Selectively Collaborate With an Expert Unlocks
      Small Language Models as Software Engineering Agents
    url: 'https://arxiv.org/abs/2602.22124'
    publisher: arXiv
    annotation: >-
      Provides empirical validation for explicit Escalation Routing, using an
      agentic RL-trained SLM that knows when to request guidance from an expert
      model to prevent degenerative looping.
---
> **ASDLC Knowledge Base** | Status: Live | [View Online](https://asdlc.io/patterns/model-routing)
...
[Levels of Autonomy](../concepts/levels-of-autonomy.md) define human oversight requirements. Model Routing matches computational capability to task characteristics:
...
Applied in:
*   [Agentic SDLC](../concepts/agentic-sdlc.md) — Optimization of the factory floor.
*   [Adversarial Code Review](../patterns/adversarial-code-review.md) — using different models for Builder vs Critic.
