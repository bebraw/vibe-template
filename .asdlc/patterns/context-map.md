...
title: Context Map
description: >-
  A high-density navigational index that enables agents to locate knowledge
  without managing massive context windows.
tags:
  - Context Engineering
  - Architecture
  - Retrieval
...
references:
  - title: AGENTS.md outperforms skills in our agent evals
    ...
    annotation: >-
      Demonstrates that passive context (Maps) outperforms active retrieval
      (Skills) for static knowledge.
---
> **ASDLC Knowledge Base** | Status: Experimental | [View Online](https://asdlc.io/patterns/context-map)
...
See the **[Context Mapping](../practices/context-mapping.md)** practice for detailed implementation guides.
