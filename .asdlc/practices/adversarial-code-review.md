...
description: >-
  Executing automated verification using a Critic Agent to validate
  implementation artifacts against Spec contracts.
tags:
  - Code Review
  - Quality Gates
  - Multi-Agent
...
status: Live
---
> **ASDLC Knowledge Base** | Status: Live | [View Online](https://asdlc.io/practices/adversarial-code-review)
...
**Adversarial Code Review** is the practice of automating code validation by employing a specialized **Critic Agent** to review claimed implementations against established [Spec](../patterns/the-spec.md) contracts and the [Agent Constitution](../patterns/agent-constitution.md).
...
- The project maintains clear [Specs](../patterns/the-spec.md) or [CLAUDE.md](../practices/agents-md-spec.md) constitutions.
- You are using [Model Routing](../patterns/model-routing.md) to separate implementation and verification roles.
...
- **[Adversarial Code Review](../patterns/adversarial-code-review.md)** — The core architectural pattern of separated verification roles.
- **[The Spec](../patterns/the-spec.md)** — The source of truth used for validation.
- **[Agent Constitution](../patterns/agent-constitution.md)** — The set of behavioral and technical constraints enforced during review.
