...
title: PBI Authoring
description: >-
  How to write Product Backlog Items that agents can read, execute, and
  verify—with templates and lifecycle guidance.
tags:
  - Agile
...
references:
  - type: video
    ...
    annotation: >-
      Source material for the 'Prompt for the Plan' tip. Explains the Specify →
      Plan → Execute workflow.
---
> **ASDLC Knowledge Base** | Status: Live | [View Online](https://asdlc.io/practices/pbi-authoring)
...
- **[The PBI](../patterns/the-pbi.md)** — The structural pattern this practice executes

See also:

- **[The Spec](../patterns/the-spec.md)** — The permanent context PBIs reference
- **[Living Specs](../practices/living-specs.md)** — How to maintain the specs PBIs point to
