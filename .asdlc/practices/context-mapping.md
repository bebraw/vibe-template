...
description: >-
  The practice of creating high-density Context Maps to guide agents through
...
---
> **ASDLC Knowledge Base** | Status: Experimental | [View Online](https://asdlc.io/practices/context-mapping)
 ...
 **Context Mapping** is the tactical practice of generating and maintaining the **[Context Map](../patterns/context-map.md)** within your project's `AGENTS.md`. It involves auditing your knowledge assets and creating a compressed index that allows agents to navigate them autonomously.
