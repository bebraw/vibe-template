...
title: ADR Authoring
description: >-
  Step-by-step guide for creating, organizing, and maintaining Architecture
  Decision Records in your codebase.
tags:
  - Architecture
  - Documentation
  - Decision Making
...
---
> **ASDLC Knowledge Base** | Status: Live | [View Online](https://asdlc.io/practices/adr-authoring)
...
**ADR Authoring** is the practice of writing, organizing, and maintaining Architecture Decision Records throughout a project's lifecycle. This practice implements [The ADR](../patterns/the-adr.md) pattern with concrete templates, file organization conventions, and lifecycle management.
...
- **[The ADR](../patterns/the-adr.md)** — The structural pattern this practice executes

See also:

- **[Living Specs](../practices/living-specs.md)** — For feature documentation that evolves (unlike immutable ADRs)
- **[Request for Comments](../concepts/request-for-comments.md)** — For proposals that spawn multiple ADRs
- **[Context Engineering](../concepts/context-engineering.md)** — ADRs as context sources for agents
