...
- Run executable capability-kit verification directly with `npm run capabilities:verify` when iterating on Workers AI or Room State kit files and manifests.
